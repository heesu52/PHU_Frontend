            ...
            <div className="w-[90%]  mt-6 space-y-5">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center ml-5">
                        ...
                        <div className="flex p-2 ml-6 space-x-4">
                            <RadioButton id="radio-pt" label="PT" name="session-type" />
                            <RadioButton id="radio-personal" label="개인운동" name="session-type" />
                        </div>
                    </div>
                </div>
                {/* 몸무게 */}
                <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 ml-7">
                        <input type="number" className="w-[80px] h-8 border rounded-lg border-custom-skyblue flex text-center"></input>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-center gap-5 p-2">
                        <CheckButton id="radio-pt" label="어깨" name="session-type" readOnly={false}/>
                        <CheckButton id="radio-pt" label="가슴" name="session-type" readOnly={false}/>
                        <CheckButton id="radio-pt" label="복근" name="session-type" readOnly={false}/>
                        <CheckButton id="radio-pt" label="팔" name="session-type" readOnly={false}/>
                        <CheckButton id="radio-pt" label="하체" name="session-type" readOnly={false}/>
                        <CheckButton id="radio-pt" label="등" name="session-type" readOnly={false}/>
                        <CheckButton id="radio-pt" label="유산소" name="session-type" readOnly={false}/>
                    </div>
                </div>
                {/* 메모*/}
                <div className="space-y-2">
