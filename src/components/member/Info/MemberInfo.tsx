  ...
  return (
    <div className="flex-col w-[80%] space-y-6 flex h-[90%]">
      ...
      <div className="space-y-1">
        ...
        <textarea
            ref={goalRef}
            className="border w-[400px] min-h-[70px] rounded-lg text-sm border-custom-skyblue resize-none overflow-hidden indent-1 p-1"
      ...
      <div className="space-y-1">
        ...
        <textarea
            ref={notesRef}
            className="border w-[400px] min-h-[70px] rounded-lg text-sm border-custom-skyblue resize-none overflow-hidden indent-2 p-1"
