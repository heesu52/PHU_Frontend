...
import {
  getPTInfoApi,
  editInfoApi,
} from "../../../store/api/info/MemberInfoApi";
  ...
  return (
    <div className="flex-col w-[90%] justify-between flex h-[90%]">
      <div className="space-y-6">
        <div className="font-medium text-md md:text-base lg:text-lg">회원 정보 수정</div>
